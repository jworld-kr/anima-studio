...
const PERSONA_SECTIONS: PersonaSectionDef[] = [
  {
    ...
    fields: [
      { label: "브랜드 이름", value: "반도커피" },
      { label: "카테고리", value: "1인 카페 · 마이크로 로스터리" },
      {
        label: "한 줄 소개",
        value: "일주일에 한 가지 원두만 다루는 작은 카페.",
      },
    ],
  },
  {
    ...
    fields: [
      ...
      },
      {
        label: "말투 특징",
        value:
          "손으로 쓴 메모처럼 짧고 정직한 문장. 광고 카피 같은 톤은 쓰지 않는다.",
      },
      {
        label: "금지어·표현",
        value: "갓\n진심\n레전드\n갓생\n미친",
    ...
    fields: [
      {
        label: "배경",
        value:
          "서울의 작은 골목에 자리한 1인 카페. 매주 직접 로스팅한 단일 원두만 판매한다.",
      },
      {
        label: "관심사",
        value:
      ...
      },
      {
        label: "가치관",
        value:
          "한 번에 하나씩. 빠른 회전보다 한 잔의 완성도를 더 중요하게 여긴다.",
      },
      {
        label: "일상 루틴",
        value:
          "수요일 로스팅, 목요일 새 원두 입고, 주말은 단골과의 짧은 대화.",
      },
    ],
  },
  {
    ...
    fields: [
      ...
      {
        label: "핵심 메시지",
        value: "한 잔의 커피에는 이번 주의 시간이 담겨 있다.",
      },
      {
        label: "금기 주제",
        value: "경쟁 카페 비교\n자극적인 트렌드\n맛에 대한 단정적 평가",
    ...
    fields: [
      {
        label: "독자 정의",
        value:
          "스페셜티 커피에 관심이 있고, 빨리 마시기보다 천천히 음미하는 30·40대.",
      },
      {
        label: "관심사",
        value: "원두 산지, 핸드드립, 도자기, 작은 브랜드의 일상",
      },
      {
        label: "톤 팁",
        value:
          "가르치려 들지 말 것. 같이 마셔보자고 권하듯 부드럽게 말할 것.",
      },
    ],
  },
  {
    ...
    fields: [
      { label: "진지함", value: "7 / 10" },
      { label: "전문성", value: "8 / 10" },
      { label: "격식", value: "5 / 10" },
      { label: "깊이", value: "9 / 10" },
    ],
  },
    ...
    fields: [
      {
        label: "샘플 1",
        value:
          "이번 주 반도는 에티오피아 코케 G1 워시드.\n자몽과 흰꽃, 마지막에 가볍게 떨어지는 홍차 한 모금.",
        multiline: true,
      },
      {
        label: "샘플 2",
        value:
          "식은 다음의 맛이 더 정직합니다. 따뜻할 때보다 미지근해진 한 모금에서 그 원두의 성격이 보여요.",
        multiline: true,
      },
    ],
  },
        ...
        <SectionHeader
          ...
          description={
            <>
              ...
              <span className="block mt-2.5">
                잠재 고객의 반응을 이끌어낼 최적의 타깃, 독보적인 브랜드 성격,
                가장 자연스러운 말투까지{" "}
                <span className="text-ink-700 font-medium">
                  하나의 완벽한 페르소나
                </span>
    ...
    <section className="py-32 lg:py-40 border-t border-ink-200/60 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-[820px] px-6 lg:px-10 text-center">
        ...
        >
          이제, 브랜드의 영혼을
          <br />
          <span className="italic font-light">콘텐츠로 옮길 시간</span>입니다
